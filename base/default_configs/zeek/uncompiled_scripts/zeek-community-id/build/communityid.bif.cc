...
#line 50 "communityid.bif"
zeek::detail::BifReturnVal zeek::BifFunc::CommunityID::hash_conn_bif(zeek::detail::Frame* frame, const zeek::Args* BiF_ARGS)

#line 51 "communityid.bif"
{
	if ( BiF_ARGS->size() != 1 )
		{
		reporter->Error("CommunityID::hash_conn() takes exactly 1 argument(s)");
		return nullptr;
		}
	zeek::Connection* conn = (zeek::Connection*) ((*BiF_ARGS)[0].get()->AsRecordVal()->GetOrigin());
...
} // end of BifFunc::CommunityID::hash_conn

#line 192 "communityid.bif"
